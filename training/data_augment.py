...
data1 = open('D:\\daya\\flood\\data.csv', mode='r')
data0 = open('D:\\daya\\flood\\data1.csv', mode='r')

reader1 = csv.reader(data1)

reader0 = csv.reader(data0)

f = open('D:\\daya\\flood\\FloodML-master\\FloodML-master\\training\\final_data.csv', mode='w', newline = '')
